    ...
    for train_outer, test_outer in kf_outer.split(np.array(X)):
        ...
        try:
            ...
            study_infos = pd.DataFrame({'dataset_id': [], 'dataset_name': [], 'outer_cv_split': [],
                                        ...
                                        'duration': [], 'params_n_gp_layers': [], 'params_n_gp_out': [],
                                        'params_batch_size': [], 'params_lr': [], 'params_num_inducing': [],
                                        'params_num_samples': [], 'params_kernel_type': [], 'user_attrs_MAX_EPOCHS': [],
                                        'state': []})
        ...
        try:
            ...
            nested_resampling_infos = pd.DataFrame({'dataset_id': [], 'dataset_name': [], 'outer_run': [],
                                                    'n_layers': [], 'n_out': [], 'batch_size': [],
                                                    'lr': [], 'num_inducing': [], 'num_samples': [], 'kernel_type': [],
        ...
        study_name = "Nested Resampling DGP " + str(split_nr)
        study = optuna.create_study(direction="minimize",
                                    study_name=study_name,
                                    pruner=pruner)

        # Suggest default parameters
        study.enqueue_trial({"n_gp_layers": 2, 'n_gp_out': 1, 'num_inducing': 200, 'batch_size': 1024,
                             'lr': 0.001, 'num_samples': 10, 'kernel_type': 'rbf'})
        try:
